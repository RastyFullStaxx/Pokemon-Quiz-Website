...
const questions = [
    {
      name: "Pikachu",
      options: ["Pikachu", "Pichu", "Raichu", "Eevee"],
      answer: "Pikachu",
      cry: "assets/NtcPage/PikachuCry.mp3"
    },
    {
      name: "Snorlax",
      options: ["Snorlax", "Gengar", "Clefairy", "Mewtwo"],
      answer: "Snorlax",
      cry: "assets/NtcPage/SnorlaxCry.mp3"
    },
    {
      name: "Charizard",
      options: ["Charizard", "Pikachu", "Psyduck", "Mewtwo"],
      answer: "Charizard",
      cry: "assets/NtcPage/CharizardCry.mp3"
    },
    {
      name: "Psyduck",
      options: ["Gengar", "Psyduck", "Mewtwo", "Clefairy"],
      answer: "Psyduck",
      cry: "assets/NtcPage/PsyduckCry.mp3"
    },
    {
      name: "Gengar",
      options: ["Mewtwo", "Snorlax", "Gengar", "Clefairy"],
      answer: "Gengar",
      cry: "assets/NtcPage/GengarCry.mp3"
    },
    {
      name: "Clefairy",
      options: ["Clefairy", "Eevee", "Pikachu", "Charizard"],
      answer: "Clefairy",
      cry: "assets/NtcPage/ClefairyCry.mp3"
    },
    {
      name: "Mewtwo",
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    bgMusic.volume = 0;
    bgMusic.loop = true;
    bgMusic.play().then(() => fadeInMusic(bgMusic))
    .catch(() => console.log("Music will start after interaction."));
  ...
  function loadQuestion() {
    ...
    // Replay cry when audio button clicked
    audioButton.onclick = () => {
      if (currentCry) {
